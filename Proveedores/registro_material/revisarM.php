                  ...
                  if(!$query){
                    ...
                    if($row2<1){
                      ...
                      for($i=0; $i<=$row;$i++){
                       ...
                       ?>
                       <th><a href="actualizarM.php?id=<?php echo $row['idMaterial'] ?>" class="btn btn-info">Editar</a></th>
                        <th><a href="deleteM.php?id=<?php echo $row['idMaterial'] ?>" class="btn btn-danger">Eliminar</a></th>
                  </tr>
                        <?php
                        $row = mysqli_fetch_array($query);
                    }
